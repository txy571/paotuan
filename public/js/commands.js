...
const CMD_TYPES = 'SAN|HP|LUCK|TRAIT|REMOVE_TRAIT|CHRONICLE|SKILL_CHECK|ITEM|REMOVE_ITEM|NPC|CLUE|PLOT|MEMORY|ACT|SCENARIO_META|TASK_UPDATE|OUTLINE_UPDATE|检定请求|检定结果|掷骰请求|INITIATIVE|END_COMBAT|CHASE|END_CHASE';
